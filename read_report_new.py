...
df1 = df1[df1['Minimum'].isna()]
df2 = df2[df2['Minimum'].isna()]
df3 = df3[df3['Minimum'].isna()]
df5 = df5[df5['Minimum'].isna()]
df6 = df6[df6['Minimum'].isna()]
df4 = df4[df4['Resource Name'].isna()]
